...
def do_something():
    ...
    facebook_username = "astha8862@gmail.com"
    facebook_password = "Avengers@5"
    ...
    def login():
        ...
        page = loadPage(
            opener, "https://www.linkedin.com/uas/login").decode('utf-8')
        ...
        page = loadPage(
            opener, "https://www.linkedin.com/checkpoint/lg/login-submit", login_data).decode('utf-8')
        ...
        try:
            ...
            print(
                "Error logging in! Try changing language on social networks or verifying login data.")
    ...
    peoplelist = []
    args.format = "imagefolder"
    args.input = "/home/vishal/Desktop/my_edited_social_mapper/Input-Examples/imagefolder"
                ...
                if 'com.linkedin.voyager.search.SearchProfile' in c['hitInfo'] and c['hitInfo']['com.linkedin.voyager.search.SearchProfile']['headless'] == False:
                    try:
                        ...
                        urllib.request.urlretrieve(
                            person_image, "temp-targets/" + full_name + ".jpg")
                        person = Person(
                            first_name, last_name, full_name, "temp-targets/" + full_name + ".jpg")
                        person.person_imagelink = person_image
...
if __name__ == '__main__':
    app.run(host= '192.168.43.139', port=9000)
